...
3. from an administrator console, execute:
  ...
  choco install less bat gzip ripgrep grep fd fzf far netcat curl wget procexp mingw make (choco installs the tools in c:\ProgramData\chocolatey\bin these tools are needed for lsp config)
  ```
